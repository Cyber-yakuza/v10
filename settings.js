...
SESSION_ID: process.env.SESSION_ID === undefined ? 'e2hWkIQa#JgWCXbeuJiOEY3JDkEOITsFK4mUZA3lc-N-mWoWIGUM' : process.env.SESSION_ID,
...
AI_REPLAY: process.env.AUTO_REPLY === undefined ? "true" : process.env.AI_REPLAY,
